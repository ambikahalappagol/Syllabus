...
<div class="jumbotron">        
  ...
  <form class="form-horizontal" action="Studentupdate.jsp">
  ...
  /* String sid = request.getParameter("id");
	 ...
	 */	try {
			...
			String sql = "select * from Student_reg where id="+ id;
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <select class="form-control" value="<%=rs.getString(9) %>" name="Course">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <select class="form-control" value="<%=rs.getString(10) %>" name="Sem">
